...
<body class="min-h-screen bg-slate-900 antialiased overflow-x-hidden">
    ...
    <div class="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        ...
        <div class="absolute top-1/4 left-1/4 w-72 h-72 sm:w-96 sm:h-96 bg-blue-500/25 rounded-full blur-3xl animate-pulse-slow">
        </div>
    ...
    <!-- HERO -->
    <main class="relative px-4 sm:px-6 lg:px-8 pt-[calc(var(--nav-h)+2.25rem)] sm:pt-[calc(var(--nav-h)+3rem)] pb-24">
        <div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            ...
            <div class="text-center lg:text-left space-y-7 sm:space-y-8">
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.12]">
                    Platform Manajemen
                ...
                <!-- (Opsional) Statistik: kalau belum dipakai, sebaiknya tidak tampil agar tidak bikin ruang kosong -->
                <!--
                    ...
                    <div
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-white/70 text-sm leading-relaxed">
                                    Tagihan seragam per anggota. Fitur override untuk pengurus inti dengan tabel pivot
                                    yang akurat.
                                </p>
                            </div>
                        </div>
        ...
        <!-- MOBILE/TABLET preview cards (agar tetap “rapi” dan tidak kosong) -->
        <div class="lg:hidden mt-10 max-w-2xl mx-auto grid sm:grid-cols-2 gap-4">
            <div class="bg-white/8 backdrop-blur-xl border border-white/15 rounded-2xl p-5">
            ...
            <div class="bg-white/8 backdrop-blur-xl border border-white/15 rounded-2xl p-5 sm:col-span-2">
                <div class="flex items-start gap-3">
        ...
        <!-- Arrow: sembunyikan di layar kecil agar tidak nabrak konten -->
    ...
    <!-- FEATURES -->
    <section id="features"
        class="relative py-20 sm:py-24 px-4 sm:px-6 lg:px-8 scroll-mt-24 sm:scroll-mt-28">
