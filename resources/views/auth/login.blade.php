...
<head>
    ...
    <style>
        ...
        /* 2. Sembunyikan ikon mata bawaan browser */
        input::-ms-reveal,
        input::-ms-clear {
            display: none;
        }
    ...
    <div class="relative min-h-full flex items-center justify-center px-4 py-10">
        <div class="w-full max-w-6xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                <!-- Left: Branding -->
                <div class="text-center lg:text-left space-y-6 lg:pl-8">
                    <a href="/" class="inline-flex items-center gap-3 group">
                        <div
                            class="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 shadow-lg transition-transform group-hover:scale-110">
                ...
                <div class="w-full max-w-md mx-auto lg:mx-0 lg:ml-auto">
                    <div
                        class="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl py-8 px-6 sm:px-10">

                        <h3 class="text-xl font-bold text-white mb-6 text-center lg:text-center">Masuk ke Akun</h3>
                        ...
                        @php
                            ...
                            // Ubah beberapa pesan bawaan Laravel jadi versi Indonesia yang lebih jelas
                        ...
                        @if ($statusMessage)
                            <div
                                class="mb-6 p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/25 flex gap-3 items-start">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-5">
                            ...
                            <div class="space-y-2">
                                ...
                                <input id="email" type="email" name="email" value="{{ old('email') }}" required
                                    autofocus autocomplete="username" inputmode="email" spellcheck="false"
                                    autocapitalize="off" oninput="this.value = this.value.toLowerCase()"
                                    pattern="^[^@\s]+@(gmail\.com|googlemail\.com)$"
                                    title="Masuk menggunakan email Gmail yang terdaftar, contoh: nama@gmail.com"
                                    class="block w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white placeholder-white/40 outline-none transition-all focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/30 hover:bg-white/10"
                            ...
                            <div class="space-y-1" x-data="{ show: false }">
                                ...
                                <div class="relative">
                                    <input id="password" :type="show ? 'text' : 'password'" name="password" required
                                        ...
                                        class="block w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 pr-12 text-white placeholder-white/40 outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-transparent transition-all hover:bg-white/10"
                                        placeholder="••••••••">

                                    <button type="button" @click="show = !show"
                                        class="absolute inset-y-0 right-0 px-4 flex items-center text-white/40 hover:text-white/70 hover:text-white transition-colors focus:outline-none">
                            ...
                            <button type="submit"
                                class="w-full rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 px-4 py-3 font-semibold text-white shadow-lg hover:shadow-xl hover:from-blue-500 hover:to-purple-500 transition-all duration-200">
                                Masuk
                            </button>
                        </form>
                        ...
                        <div class="my-6 flex items-center gap-3">
                            ...
                            <div class="relative flex justify-center text-sm">
                                <span class="px-4 bg-[#1e1b4b]/80 backdrop-blur-xl text-white/50 rounded-full">atau
