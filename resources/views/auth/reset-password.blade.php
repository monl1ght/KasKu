...
<head>
    ...
    <title>Reset Password - KasKu</title>
    ...
    <style>
        ...
        @keyframes glow {
            ...
            50% { box-shadow: 0 0 30px rgba(147, 51, 234, 0.35); }
        }
        ...
        .input-glow:focus {
            box-shadow: 0 0 0 3px rgba(59, 130, 246, 0.18), 0 0 20px rgba(59, 130, 246, 0.25);
        }
    ...
    <div class="relative min-h-full flex items-center justify-center px-4 py-10">
        <div class="w-full max-w-md">
            <div class="glass-card rounded-3xl shadow-2xl overflow-hidden animate-glow slide-in">
                ...
                <div class="px-8 py-8">
                    ...
                    @if ($errors->any())
                        <div
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="text-sm text-rose-200 leading-relaxed space-y-1">
                                    <p class="font-semibold">Ada yang perlu diperbaiki:</p>
                                    <ul class="list-disc list-inside text-rose-200/90">
                    ...
                    <form id="resetPasswordForm" method="POST" action="{{ route('password.store') }}" class="space-y-6">
                        ...
                        <!-- Email -->
                        <div class="space-y-2">
                            <label class="block text-sm font-semibold text-white/90" for="email">Alamat Email</label>
                        ...
                        <!-- Password -->
                        <div class="space-y-2">
                            <label class="block text-sm font-semibold text-white/90" for="password">Password Baru</label>
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-white/40 group-focus-within:text-blue-400 transition-colors"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M12 11c0-1.657-1.343-3-3-3S6 9.343 6 11v2a2 2 0 002 2h2a2 2 0 002-2v-2z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M18 11v-1a6 6 0 10-12 0v1" />
                                    </svg>
                                </div>
                                <input
                                    id="password"
                        ...
                        <div class="space-y-2">
                            <label class="block text-sm font-semibold text-white/90" for="password_confirmation">Konfirmasi Password</label>
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-white/40 group-focus-within:text-blue-400 transition-colors"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mt-6 text-center text-xs text-white/40">
                <p>Password baru minimal harus memenuhi aturan keamanan sistem.</p>
            </div>
        </div>
    </div>

    <script>
        // Loading UI saat submit (tanpa mencegah submit)
